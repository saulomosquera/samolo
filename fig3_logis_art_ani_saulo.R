...
# ggplot2 traza el gráfico estático con etiquetas
Estático=ggplot(data_label, aes(time, P, group = forcats::fct_inorder(group))) +    
...
# traza el gráfico dinámico
Dinámico = Estático + transition_reveal(time)+
  labs(title = "Tiempo: {frame_along}, Evolución de las trayectorias en el tiempo.")
Dinámico

# traza el gráfico dinámico con características adicionales
ani_saulo=animate(Dinámico, width = 700, 
                  height = 600, fps = 25, duration = 15, rewind = FALSE)
ani_saulo